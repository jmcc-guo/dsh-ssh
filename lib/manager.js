/**
 * @dsh-external/dsh-ssh — SSH connection manager.
 *
 ...
 * @module @dsh-external/dsh-ssh/manager
 */
...
export class SshManager {
  ...
  async connectWithParams(params) {
    ...
    const created = await this.createRecord({ name, host: params.host, port: params.port, user: params.user, auth: params.auth, source: 'ai' });
